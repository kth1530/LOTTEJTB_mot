...
data +='			<li class="swiper-slide on swiper-slide-active"><a href="#" onclick="moveMenu(\'' + homeUrl +'/goods/categoryOther.do?ctg=5745\',0)">호텔</a></li>';
...
data +='				<li style="font-size: 17px;"><a href="#" onclick="moveMenu(6339)">해외/국내호텔</a></li>';
data +='				<li style="font-size: 17px;"><a href="#" onclick="moveMenu(\'' + homeUrl +'/goods/categoryOther.do?ctg=5745&subCtg=6445\', 2)">온라인전용 호텔특가</a></li>';
...
data +='				<li><a href="#" onclick="moveLink(\"https://m.facebook.com/lotteholiday/\", \"_blank\")"><span></span><span>롯데제이티비 FACEBOOK</span></a></li>';
