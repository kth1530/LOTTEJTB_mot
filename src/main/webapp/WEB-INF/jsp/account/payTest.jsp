...
//	document.lpayMemCertIf.action="http://www.lottejtb.com/jsp/lpay/lpayMemCertIf.faces";
	document.lpayMemCertIf.action="https://security.lottejtb.com/jsp/lpay/lpayMemCertIf.faces";
...
//	document.dlp.action="http://www.lottejtb.com/jsp/lpay/lpay_json.jsp";
	document.dlp.action="https://security.lottejtb.com/jsp/lpay/lpay_json.jsp";
	document.dlp.submit();
	}else{
		hideLoading();
		setAlert('인증에 실패했습니다.');
...
//    document.lpayTranCertIf.action="http://10.141.1.40/jsp/lpay/lpayTranCertIf.faces";
    ...
    document.lpayTranCertIf.action="https://security.lottejtb.com/jsp/lpay/lpayTranCertIf.faces";
...
//	document.lpayAprvIf.action="http://10.141.1.40/jsp/lpay/lpayAprvIf.faces";
	...
	document.lpayAprvIf.action="https://security.lottejtb.com/jsp/lpay/lpayAprvIf.faces";
...
//	document.dlpcard.returnURL.value = "http://mdev.lottejtb.com/returnRegDlp.jsp";
	document.dlpcard.returnURL.value = "https://m.lottejtb.com/returnRegDlp.jsp";
//	document.dlpcard.returnURL.value = "http://mdev.lottejtb.com/account/returnRegDlp.do";
//	document.dlpcard.action="http://10.141.1.40/jsp/lpay/lpayRegPayment.faces";
	...
	document.dlpcard.action="https://security.lottejtb.com/jsp/lpay/lpayRegPayment.faces";
...
function chkGiftNumberCertIf(id, type){
	...
	document.giftNumberCertIf.action="https://security.lottejtb.com/jsp/gift/giftNumberCertIf.faces";
...
<!--						<button type="button" data-role="none" id="applyLpoint">본인확인</button> -->
						...
						<p class="chkbox">
							<span><input id="chk_ck30" type="checkbox"
								data-role="none"></span> <label for="chk_ck30">전체사용</label>
						</p>
					</div>
				</li>
				<!-- li>
...
-->
			...
			<ul class="pop_chk_list payinfolist">
				<li class="pop_paytext1">
					...
					<p class="ppred">- 총 입금액 <span>0원</span></p>
