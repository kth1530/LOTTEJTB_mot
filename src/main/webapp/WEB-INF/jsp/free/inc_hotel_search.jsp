...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#srch_night_days").click(function(){
			if($("div[ft-att=HTGroup]").find("#dep_dt").text() == "미지정"){
				setAlert("출발일을 선택해주세요.");
				return false;
			}
		});
...
<!-- 호텔파트 -->
<div class="chkpart hotelpart" id="hotel_search_div">
	<p class="pop_htvtitle">해외호텔</p>
	<div class="ht_clone ps_view mt7" ft-att="HTGroup">
		<div class="fs_search">
			<div class="csbox">
				<form name="" method="#">
					<fieldset>
						...
						<input type="text" name="srch_arr_ct_dis" id="srch_arr_ct_dis" class="layerOpener" data-url="/pop/pop_hotel_city_select.do?availTy=HT"  data-ctn="full" data-role="none" style="cursor='hand';"
	                     ...
	                     <input type="hidden" name="searchRntCity" id="searchRntCity" value="" />
		...
		<div class="selectchk chkv_show2">
			...
			<p class="chkbox hc_show2">
				<span><input id="chk_cusm6" type="checkbox" data-role="none" onclick="fn_rcEqualsChkFromHtl()"/></span>
				...
				<ul class="personnel psa2" data-msg="성인, 아동의 합이 9명을 넘길 수 없습니다.">
					<li>
						<dl>
							...
							<dd class="ps_cunt" id="ps_ad_cunt_1"><span>1</span></dd>
					...
					<li>
						<dl>
							<dt><em>아동</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ch_cunt_1"><span>0</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
				</ul>
				...
				<ul class="personnel psa2" data-msg="성인, 아동의 합이 9명을 넘길 수 없습니다.">
					<li>
						<dl>
							<dt><em>성인</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ad_cunt_2"><span>1</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
					<li>
				...
				<ul class="personnel psa2" data-msg="성인, 아동의 합이 9명을 넘길 수 없습니다.">
					<li>
						<dl>
							<dt><em>성인</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ad_cunt_3"><span>1</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
					<li>
				...
				<ul class="personnel psa2" data-msg="성인, 아동의 합이 9명을 넘길 수 없습니다.">
					<li>
						<dl>
							<dt><em>성인</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ad_cunt_4"><span>1</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
					<li>
				...
				<ul class="personnel psa2" data-msg="성인, 아동의 합이 9명을 넘길 수 없습니다.">
					<li>
						<dl>
							<dt><em>성인</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ad_cunt_5"><span>1</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
					<li>
				...
				<ul class="personnel psa2" data-msg="성인, 아동의 합이 9명을 넘길 수 없습니다.">
					<li>
						<dl>
							<dt><em>성인</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ad_cunt_6"><span>1</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
					<li>
						<dl>
							<dt><em>아동</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ch_cunt_6"><span>0</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
				</ul>
				...
				<ul class="personnel psa2" data-msg="성인, 아동의 합이 9명을 넘길 수 없습니다.">
					<li>
						<dl>
							<dt><em>성인</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ad_cunt_7"><span>1</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
					<li>
						<dl>
							<dt><em>아동</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ch_cunt_7"><span>0</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
				</ul>
				...
				<ul class="personnel psa2" data-msg="성인, 아동의 합이 9명을 넘길 수 없습니다.">
					<li>
						<dl>
							<dt><em>성인</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ad_cunt_8"><span>1</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
					<li>
						<dl>
							<dt><em>아동</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ch_cunt_8"><span>0</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
				</ul>
				...
				<ul class="personnel psa2" data-msg="성인, 아동의 합이 9명을 넘길 수 없습니다.">
					<li>
						<dl>
							<dt><em>성인</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ad_cunt_9"><span>1</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
					<li>
						<dl>
							<dt><em>아동</em></dt>
							<dd class="ps_c1"><button data-role="none">내림</button></dd>
							<dd class="ps_cunt" id="ps_ch_cunt_9"><span>0</span></dd>
							<dd class="ps_c2"><button data-role="none">올림</button></dd>
						</dl>
					</li>
				</ul>
