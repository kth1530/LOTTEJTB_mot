...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDb3QbLpTEk_Pa-32zEyUABiheOLebzQyQ&callback=initMap" async defer></script>
...
<script type="text/javascript">
	...
	cmtGooglemapPopJs = {
			...
			detailInfo : function(_data){
				...
				$('.infoWindow').on('click', function() {
					moveLink(_data.radarData.result.url, '_system'); ;
				});
