		...
		cfn_ajax({
			...
			success: function(data) {
				if(data.code == "00"){
					...
					cardno	=	cardno.replace(/(^\s*)|(\s*$)/gi, "");
          
					if(cardno.length > 15 ){
						var card1 = cardno.substring(0,4);
						var card2 = cardno.substring(4,8);
						var card3 = cardno.substring(8,12);
						var card4 = cardno.substring(12, 16);
	...
	$(document).ready(function() {
		...
		$("#closePopup").click(function(){
			...
			cfn_ajax({
				type : "POST",
				async : false,
				url: "/free/account/LPointAuthAjax.do",
				data: formData,
				dataType: "json",
				cache : false,
				noloading : "yes",
...
<div class="layerPopup">
    <div class="layerPop">
			...
			<!-- 내용끝 -->
			<div class="popFoot">
				<div class="layerBtns"><button type="button" class="layerClose1" id="closePopup">확인</button></div>
			</div>
    </div>
</div>