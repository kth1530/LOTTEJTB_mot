...
<script type="text/javascript">
	...
	function fn_init() {
		...
		// console.log("fn_init >>>> selectedStartDay : " + selectedStartDay);
	...
	function calendarAirs(sYear, sMonth) {
		...
		*/
		...
		for ( i=1; i<=lastDay; i++){  // 해당 월의 달력 
			...
			if(col==0){    //일요일이면
				calendarStr += "			<td class='' id='"+ tagReserveDay +"' name='" + tagReserveDay + "' onclick=\"fn_selectDay(\'" + day + "\')\">"+i+"</td>";
...
<div class="layerPopup">
	<div class="layerPop">
		...
		<ul class="pop_clddayg">
			<li>
				<p>출발일</p>
				<p><div id='selectedStartDay'></div></p>
			</li>
			<li>
				<p>도착일</p>
				<p><div id='selectedEndDay'></div></p>
			</li>
		</ul>
		<!-- 내용끝 -->
		<div class="popFoot">
