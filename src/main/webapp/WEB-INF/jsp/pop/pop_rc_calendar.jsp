...
<script type="text/javascript">	
	...
	function calendarAirs(sYear, sMonth) {
		...
		*/
		...
		var nowDay = nowDay.substring(6, 8);
		
		var thisDate = new Date(nowYear, parseInt(nowMonth) - 1, nowDay);
		
		console.log("thisDate=" + thisDate); */
		
		/* if(location.pathname == "/main.do"){
			thisDate.setDate(thisDate.getDate() + 1);
			nowDay = thisDate.format("yyyyMMdd");
		}else if(location.pathname == "/free/main.do"){
			...
			if(nullToBlank(sessionStorage.airSelData) != "" && sessionStorage.airSelData != '[]'){
				thisDate.setDate(thisDate.getDate() + 4);
			}else if(nullToBlank(sessionStorage.hotelBasketData) != "" && sessionStorage.hotelBasketData != '[]'){
				thisDate.setDate(thisDate.getDate() + 4);
			}else{
				thisDate.setDate(thisDate.getDate() + 1);	
			}
	...
	function settingDate(){
		...
		if(nullToBlank(selEndDay) != ""){
			...
			availGroup.find("#take_date").val(selStartDay);
			availGroup.find("#return_date").val(selEndDay);
		}else{
			availGroup.find("#dep_dt").html(startYear + "." + startMonth + "." + startDay);
			availGroup.find("#dep_dt").removeClass("noSelect");
			...
			availGroup.find("#take_date").val(selStartDay);
			availGroup.find("#return_date").val('');
...
<div class="layerPopup">
	<div class="layerPop">
		...
		<div class="popCon">
			<div class="popHead">
				<div class="popTpart">
					<strong class="popTitle">차량 인수일/반납일 선택</strong>
