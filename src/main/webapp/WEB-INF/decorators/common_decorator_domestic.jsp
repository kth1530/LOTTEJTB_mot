...
<!-- 			<li class="swiper-slide" id="gnb_5743"><a onclick="moveMenu('/goods/categoryOther.do?ctg=5743')">자유여행</a></li> -->
	...
	<script>
		$(function(){
			if(location.pathname == "/domestic/dmt_category_domestic.do"){
				$("#gnb_5740").addClass("on");	
			}else if(location.pathname == "/domestic/dmt_detail_domestic.do"){
				$("#gnb_5745").addClass("on");
			} 
