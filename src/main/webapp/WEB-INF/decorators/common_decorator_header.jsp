...
<div data-role="page" class="bodyWrap">
	...
	<div data-role="header" data-position="fixed"  data-tap-toggle="false">
		...
		<a href="#nav-panel" data-role="none"><img src="http://mdev.lottejtb.com:8085/resources/images/btn/Header_Leftmenu.png" alt="" /></a>
		<a href="#" onclick="javascript:fn_moveMytour();" data-role="none"><img src="http://mdev.lottejtb.com:8085/resources/images/btn/Header_Login.png" alt=""/></a>
...
<!-- 			<li class="swiper-slide" id="gnb_5743"><a onclick="moveMenu('/goods/categoryOther.do?ctg=5743')">자유여행</a></li> -->
	...
	<!-- <div data-role="footer" data-position="fixed" data-tap-toggle="false" id="foot" >
		<ul>
			<li><a href="#" onclick='moveMenu("/main.do", 1)'><img src="http://mdev.lottejtb.com:8085/resources/images/btn/Footer_home.png" alt=""/></a></li>
			<li><a href="#" onclick="javascript:fn_goToList();" data-rel="back"><img src="http://mdev.lottejtb.com:8085/resources/images/btn/Footer_pre.png" alt=""/></a></li>
			<li><a href="#" data-rel="forward" onclick='pageForward()'><img src="http://mdev.lottejtb.com:8085/resources/images/btn/Footer_next.png" alt=""/></a></li>
			<li><a href="#" onclick="javascript:fn_moveMytour()"><img src="http://mdev.lottejtb.com:8085/resources/images/btn/Footer_human.png" alt=""/></a></li>
			<li class="sns">
				...
				<a href="#" class="snsLink"><img src="http://mdev.lottejtb.com:8085/resources/images/btn/Footer_share.png" alt=""/></a>
...
<!-- 			<li><a href='#' onclick="moveMenu('/shop/shopList.do', 0)">매장안내</a></li>
	...
	<div data-role="panel" data-position-fixed="true" data-display="overlay" data-theme="a" data-overlay-theme="a" id="nav-panel1">
		<ul data-role="listview">
			<li data-icon="delete"><a href="#" data-rel="close">닫기</a></li>
			<li><a href="#" data-ajax="false" id="clause">list</a></li>
			<li><a href="#" data-ajax="false" id="clause">list</a></li>
			<li><a href="#" data-ajax="false" id="clause">list</a></li>
			<li><a href="#" data-ajax="false" id="clause">list</a></li>
			<li><a href="#" data-ajax="false" id="clause">list</a></li>
