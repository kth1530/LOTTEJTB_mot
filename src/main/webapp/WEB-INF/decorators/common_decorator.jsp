...
<!-- 			<li class="swiper-slide" id="gnb_5743"><a onclick="moveMenu('/goods/categoryOther.do?ctg=5743')">자유여행</a></li> -->
	...
	<script>		
		...
		var fn_socialLogout = function() {
			...
			if(devType == 0){
				document.logoutFrm.action = "https://www.lottejtb.com/jsp/sso/logout_middle_page_mobile.jsp"; 
				//document.logoutFrm.action = "https://testmember.lpoint.com/door/sso/mblLogout.jsp?sid=LOTTEJTB&sch=&returnurl=http://m.lottejtb.com&opentype="; 
				//document.location.href = "https://testmember.lpoint.com/door/sso/mblLogout.jsp?sid=MLOTTEJTB&sch=&returnurl=&opentype=";
			}else{
				document.logoutFrm.action = "https://www.lottejtb.com/jsp/sso/logout_middle_page_mobile.jsp";
				//document.logoutFrm.action = "https://member.lpoint.com/door/sso/mblLogout.jsp?sid=LOTTEJTB&sch=&returnurl=http://m.lottejtb.com&opentype=";
				//document.logoutFrm.action = "http://www.lottejtb.com/jsp/sso/logout.jsp";
		...
		<ul>
			...
			<li class="sns">
				<nav class="containerT">
					...
					<a href="https://m.facebook.com/lottejtbofficial/" class="buttons"></a>
	...
	*/
	...
	//[JEH] 항공과 로그인 호환 문제로 추가 - 20190226
		...
		if(!onl_cno){
	        ...
	        document.writeln("<scr"+"ipt language='javascript' src='nowAdd'></scr"+"ipt>");
		}
