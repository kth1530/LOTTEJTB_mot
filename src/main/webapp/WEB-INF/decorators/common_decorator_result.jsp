...
<head>
	...
	<!-- 
	<script src="<c:url value='/resources/common/js/common_decorator.js' />"></script>
	<script src="<c:url value='/resources/common/js/common_decorator2.js' />"></script>
	 -->
...
<body>
<div data-role="page" class="bodyWrap" style="padding-bottom:52px;">
	<!-- header /common/js/header.js 파일에서 가져옴 -->
	<div data-role="header" data-position="fixed"  data-tap-toggle="false">
		<h1><a href="#" onclick='moveMenu("http://m.lottejtb.com/main.do", 1)'>감동의 곁에, 언제나 롯데제이티비</a></h1>
...
<!-- 			<li class="swiper-slide" id="gnb_5743"><a onclick="moveMenu('/goods/categoryOther.do?ctg=5743')">자유여행</a></li> -->
			...
			<!-- 
			<li class="swiper-slide" id="gnb_5741"><a onclick="moveMenu('http://m.lottejtb.com/goods/category.do?ctg=5741', 1)">해외</a></li>
			<li class="swiper-slide" id="gnb_free"><a onclick="moveMenu('/free/main.do', 1)">자유여행</a></li>
			<li class="swiper-slide" id="gnb_5809"><a onclick="javascript:fn_airAppLink();">항공권</a></li>
			<li class="swiper-slide" id="gnb_5745"><a onclick="moveMenu('http://m.lottejtb.com/domestic/dmt_detail_domestic.do?url=http://m.cp.hotelpass.net/search.asp?cp_agent=jtbmo&ctgname=호텔',1)">호텔</a></li>
			<li class="swiper-slide" id="gnb_rentalCar"><a onclick="moveMenu('/free/main.do?tabType=rent', 1)">렌트카</a></li>
			<li class="swiper-slide" id="gnb_5746"><a onclick="moveMenu('http://m.lottejtb.com/goods/categoryOther.do?ctg=5746', 1)">허니문</a></li>
			<li class="swiper-slide" id="gnb_5747"><a onclick="moveMenu('http://m.lottejtb.com/goods/categoryOther.do?ctg=5747', 1)">골프</a></li>
			<li class="swiper-slide" id="gnb_5740"><a onclick="moveMenu('http://m.lottejtb.com/domestic/dmt_category_domestic.do?ctg=5740',1)">국내</a></li>
			 -->
			<!-- li class="swiper-slide" id="gnb_5742"><a onclick="moveMenu('http://m.lottejtb.com/goods/theme.do?ctg=5742', 1)">테마</a></li -->
		</ul>
	</div>
	<div class="main">
	...
	<div data-role="footer" data-position="fixed" data-tap-toggle="false" id="foot" >
		<ul>
			...
			<li><a href="#" onclick="javascript:fn_goToList();" data-rel="back"><img src="/resources/images/btn/Footer_pre.png" alt=""/></a></li>
	...
	<a href="#"  class="go-top go60"><i class="fa fa-angle-up"></i></a>
	<div  class="gfoot"  data-position="fixed" data-tap-toggle="false" data-role="footer">
	<ul id="bottom_basket_rect">
	    <!-- li style="background:#f7415b"><a href="javascript:void(0);" id="basketCnt" data-url='/pop/pop_select_air.do' data-role='none' data-ok='yes' data-ctn='full' onclick="fn_airSelect()"><img src="/resources/images/ico/ico_cart.png" alt=""/></a></li -->
	    <li style="background:#f7415b"><a href="javascript:void(0);" class="layerOpener" id="basketCnt" data-url='/pop/pop_select_air.do?mode=show' data-role='none' data-ok='yes' data-ctn='full'><img src="/resources/images/ico/ico_cart.png" alt=""/></a></li>
	    <li style="background:#7040b3"><a href="javascript:void(0);" onclick="free_prevStep();"><img src="/resources/images/ico/ico_foot_prev.png" alt=""/></a></li>
	    <li style="width:60%;background:#353163"><a href="javascript:void(0);" class="img layerOpener" id="selectPut" data-url='/pop/pop_select_air.do?mode=add' data-role='none' data-ok='yes' data-ctn='full'><img src="/resources/images/btn/Footer_goods_reserve.png" alt=""/>선택담기</a></li>
	</ul>
	</div>
...
<!-- 			<li><a href='#' onclick="moveMenu('/shop/shopList.do', 0)">매장안내</a></li>
		...
		<!--  a href="#" onclick="moveMenu('/setting/setting.do', 1)" class="setting_btn"><span></span><em>설정</em></a -->
	</div>
