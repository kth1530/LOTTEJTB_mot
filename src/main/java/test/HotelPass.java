...
public class HotelPass {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String xmlFile = "D:\\J2EE\\workspace\\LOTTEJTB\\LotteJTB\\src\\main\\java\\test\\HotelPass.xml";
        ...
        try {
            URL searchUrl = new URL("http://xml.hotelpass.com/htpws_v04/htpws_v04.asmx?op=gfnGetBaseCode");
