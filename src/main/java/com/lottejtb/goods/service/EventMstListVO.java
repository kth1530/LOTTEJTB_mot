...
/**
* 클래스명    :  행사 정보를 가져오는  클래스   
* @ClassDesc  :  행사 정보를 가져오는  클래스   
* @FileName   : EventMstListVO.java
* @TableName  :
* @SpecDesc   : N/A
* @Author     : 
...
public class EventMstListVO extends CommDefaultVO {
	private static final long serialVersionUID = 8552220089276147355L;
	...
	public int getGoods_join_cd() {
		return goods_join_cd;
	}
	public void setGoods_join_cd(int goods_join_cd) {
	...
	public void setPro_desc(String proc_desc) {
