...
/**
* 클래스명    :  상품 이미지 정보를 담고 있는 클래스   
* @ClassDesc  : 상품 이미지 정보를 담고 있는 클래스   
* @FileName   : GoodsImgVO.java
* @TableName  :
* @SpecDesc   : N/A
* @Author     : 
...
public class GoodsImgVO extends CommDefaultVO {

	private static final long serialVersionUID = 2998357706882222791L;
	...
	public String fn_chgImage(String image, String type) {
		int lastIndex = 0;
