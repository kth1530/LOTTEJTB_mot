...
/**
* 클래스명    :  사이트 옵션 정보를 담고 있는 클래스   
* @ClassDesc  : 사이트 옵션 정보를 담고 있는 클래스   
* @FileName   : SiteOptionsVO.java
* @TableName  :
* @SpecDesc   : N/A
* @Author     : 
...
public class SiteOptionsVO extends CommDefaultVO implements Serializable {
	private static final long serialVersionUID = 2925146300710671576L;
