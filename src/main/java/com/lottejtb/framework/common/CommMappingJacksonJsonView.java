...
public class CommMappingJacksonJsonView extends AbstractView {
    ...
    protected static final Logger LOGGER = Logger.getLogger(CommMappingJacksonJsonView.class);
	
	/**
	 * Construct a new {@code JacksonJsonView}, setting the content type to
	 * {@code application/json}.
	 */
	public CommMappingJacksonJsonView() {
	...
	protected void renderMergedOutputModel(Map model, HttpServletRequest request, HttpServletResponse response) throws Exception {
		Map filterModel = filterModel(model);
		...
		SerializerProvider provider = new StdSerializerProvider();
		provider.setNullValueSerializer(new CommNulltoEmptyStringSerializer());
		objectMapper.setSerializerProvider(provider);
		
		objectMapper.writeValue(generator, filterModel);
	}
