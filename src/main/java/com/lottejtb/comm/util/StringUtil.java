...
public class StringUtil {
    ...
    public static String multiplexReplaceAll(String value , String replaceValue){
    	String requestValue = value;
    	try {
    		String result ="";
    		String[] strValue = replaceValue.split("@");
        	for(String str : strValue){
        		String[] splitStr = str.split(":");
    			result = requestValue.replaceAll(splitStr[0], splitStr[1]);
    			requestValue = result;
    		}
		} catch (Exception e) {
			 //e.printStackTrace();
			System.err.print("Array Error!");
		}
    ...
    public static String ignoreCaseReplaceAll(String value, String replaceValue){
    	  
    	String rslt = value.replaceAll("(?i)"+value,replaceValue);
	...
	try {
		...
		//e.printStackTrace();
		System.err.print("random Function Error!");
	}
	...
	{    
    	try {
    	    ...
    	    //e.printStackTrace();
    		System.err.print("Bytes To String Change Error!");
    	}
	}
	return rtnStr;
    }
...
/**
	...
	try {
		...
		//e.printStackTrace();
		System.err.print("StringBuffer Error!");
	}
	...
	try {
		...
		//e.printStackTrace();
		System.err.print("Date Formating Error!");
	}
    ...
    public static String getHtmlStrCnvr(String srcString) {
		...
		{
			//ex.printStackTrace();
			System.err.print("String Replace Error!");
		}
     ...
     *
     * <pre>
     *   StringUtil.getBytesLength("20100901")
     * </pre>
     *
     * @param str  입력받는 문자열
     ...
     *
     * <pre>
     *   StringUtil.checkSmsContentLength("발송되었습니다.")
     * </pre>
     *
     * @param str  입력받는 문자열
     * @return str 의 바이트 수 길이
     ...
     *
     * <pre>
     *   StringUtil.rightPadding("tiger", 10, "*")
     *   returns tiger*****
     * </pre>
     *
     * @param str  입력받는 문자열
    ...
    public static String chgXssStr(String srcString) {
        ...
        catch (Exception ex)
        {
        	...
        	System.err.println("String Replace Error!");
        }
        return  rslt;
	...
	{
		return org.apache.commons.lang.StringEscapeUtils.unescapeHtml(s.replace("&amp;#39;", "`").replace("&apos;", "'"));
	}
    ...
    /**
     * <pre>
     * String 의 값을 체크하여 null 일 경우 &quot;&quot;를 리턴
     * </pre>
     * 
     * @param str
     * @return
